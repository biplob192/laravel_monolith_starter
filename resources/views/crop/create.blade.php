                                ...
                                <div class="form-group col-6">
                                    <div id="section-container">
                                        ...
                                        <div class="section card card-secondary">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="growth_stage_0">Growth Stage</label>
                                                    <input type="text" class="form-control" name="sections[0][growth_stage]" placeholder="Growth stage name" value="{{ old('sections.0.growth_stage') }}" required>
                                                </div>
                                            </div>
