                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <div id="section-container">
                                    @foreach ($crop['groth_stage'] as $index => $grothStage)
                                    <div class="section card card-secondary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="groth_stage_{{ $index }}">Growth Stage</label>
                                                <input type="text" class="form-control" name="sections[{{ $index }}][groth_stage]" placeholder="Groth stage name" value="{{ $grothStage['name'] }}"
                                                    required>
                                            </div>
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let sectionCounter = {{ $grothStageCount }};
