    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchOptions(selectElement, crop) {
                ...
                fetch("{{ route('growth_stages.certainCrop', '') }}/" + crop)
            ...
            $('#crop').on('change', function() {
                ...
                // Call fetchOptions for the initial section when the page loads
                // const initialGrowthStageSelectElement = document.querySelector('#growth_stage_0');
                // fetchOptions(initialGrowthStageSelectElement, cropID);
            ...
            function fetchOptionsForAllSections() {
                const allGrowthStageSelectElements = document.querySelectorAll('[id^="growth_stage_"]');
                allGrowthStageSelectElements.forEach((selectElement, index) => {
                    fetchOptions(selectElement, cropID);
                });
            }
        });
